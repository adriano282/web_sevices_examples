 ...
 * generated in the action.client.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddNumbersExplicitInputOutputActionResponse_QNAME = new QName("http://addnumbers.org/targetNamespace", "addNumbersExplicitInputOutputActionResponse");
    ...
    /**
     * Create an instance of {@link AddNumbersExplicitInputOutputAction }
     * 
     */
    public AddNumbersExplicitInputOutputAction createAddNumbersExplicitInputOutputAction() {
        return new AddNumbersExplicitInputOutputAction();
    }
    ...
    /**
     * Create an instance of {@link AddNumbersExplicitInputOutputActionResponse }
     * 
     */
    ...
    /**
     * Create an instance of {@link AddNumberException }
     * 
     */
    public AddNumberException createAddNumberException() {
        return new AddNumberException();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AddNumbersExplicitInputOutputActionResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://addnumbers.org/targetNamespace", name = "addNumbersExplicitInputOutputActionResponse")
    public JAXBElement<AddNumbersExplicitInputOutputActionResponse> createAddNumbersExplicitInputOutputActionResponse(AddNumbersExplicitInputOutputActionResponse value) {
        return new JAXBElement<AddNumbersExplicitInputOutputActionResponse>(_AddNumbersExplicitInputOutputActionResponse_QNAME, AddNumbersExplicitInputOutputActionResponse.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://addnumbers.org/targetNamespace", name = "getEPR")
    public JAXBElement<GetEPR> createGetEPR(GetEPR value) {
        return new JAXBElement<GetEPR>(_GetEPR_QNAME, GetEPR.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AddNumberException }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://addnumbers.org/targetNamespace", name = "AddNumberException")
    public JAXBElement<AddNumberException> createAddNumberException(AddNumberException value) {
        return new JAXBElement<AddNumberException>(_AddNumberException_QNAME, AddNumberException.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AddNumbersExplicitInputOutputAction }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://addnumbers.org/targetNamespace", name = "addNumbersExplicitInputOutputAction")
    public JAXBElement<AddNumbersExplicitInputOutputAction> createAddNumbersExplicitInputOutputAction(AddNumbersExplicitInputOutputAction value) {
        return new JAXBElement<AddNumbersExplicitInputOutputAction>(_AddNumbersExplicitInputOutputAction_QNAME, AddNumbersExplicitInputOutputAction.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://addnumbers.org/targetNamespace", name = "getEPRResponse")
